...
def create_invoice():
    ...
    invoice_text.insert(END, f'Items\t\t\tQty.\t\tCost\n')
    ...
    invoice_text.insert(END, f'*' * 75 + '\n')
    invoice_text.insert(END, f'Thank You! for visiting. See you soon')
...
# Window size
application.geometry('1240x630+0+0')
...
# Top panel
top_panel = Frame(application, bd=1, relief='solid')
top_panel.pack(side='top')

# Title tag
title_tag = Label(top_panel, text='Invoicing System', fg='azure4',
                  font=('MS Serif', 65), bg='burlywood2', width=27)
title_tag.grid(row=0, column=0)

# Left panel
left_panel = Frame(application, bd=1, relief='solid')
left_panel.pack(side='left')

# Cost panel
cost_panel = Frame(left_panel, bd=1, relief='solid', bg='azure4', padx=50)
...
# desert panel
dessert_panel = LabelFrame(left_panel, text='Desert', font=('Dosis', 19, 'bold'),
                           bd=1, relief="flat", fg='azure4')
dessert_panel.pack(side='left')

# right panel
right_panel = Frame(application, bd=1, relief='solid')
right_panel.pack(side='right')

# calculator panel
calculator_panel = Frame(right_panel, bd=1, relief='flat', bg='azure4')
calculator_panel.pack()

# invoice panel
invoice_panel = Frame(right_panel, bd=1, relief='flat', bg='azure4')
invoice_panel.pack()

# buttons panel
buttons_panel = Frame(right_panel, bd=1, relief='flat', bg='azure4')
buttons_panel.pack()

# product lists
food_list = ['Aloo gobi', 'Aloo kulcha', 'Biryani', 'Butter chicken', 'Chapati', 'Chole bhature', 'Fried Rice',
             'Biryani2']
drink_list = ['Lassi', 'Filter Coffee', 'Mango Lassi', 'Masala Chaas', 'Nimbu Pani', 'Jira Soda', 'Co-co Milk', 'Chaas']
dessert_list = ['Ras Malai', 'Gulab Jamun', 'Rasgulla', 'Ladoo', 'Kheer', 'Barfi', 'Petha', 'Kaju Katli']
...
calculator_display = Entry(calculator_panel,
                           ...
                           width=37,
                           bd=1)
calculator_display.grid(row=0, column=0, columnspan=22)
